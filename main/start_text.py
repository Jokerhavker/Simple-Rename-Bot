...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("🤖 SOURCE CODE", url="https://github.com/Jokerhavker/Simple-Rename-Bot")
        ],[
...
async def start(bot, msg, cb=True):   
    txt=f"Hello {msg.from_user.mention} i am simple rename bot with personal usage.\nthis bot is made by <b><a href=https://github.com/FilmNestAdmin>Ayush</a></b>"                                     
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/TheBotNest")
        ],[
